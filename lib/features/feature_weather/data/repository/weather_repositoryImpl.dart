...
class WeatherRepositoryImpl extends WeatherRepository {
  ...
  @override
  Future<DataState<MeteoCurrentWeatherEntity>> fetchCurrentWeatherData(
      String cityName) async {
    try {
      MeteoCurrentWeatherEntity currentWeatherEntity = await _apiProvider
  ...
  Future<List<NeshanCityItem>> fetchSuggestData(String cityName) async {
    try {
      NeshanCityEntity suggestCityEntity = await _apiProvider
          .sendRequestCitySuggestion(cityName);
  ...
  @override
  Future<DataState<AirQualityEntity>> getAirQuality(
      ForecastParams params) async {
    try {
      AirQualityEntity airQualityEntity = await _apiProvider.getAirQuality(
          params);
  ...
  Future<DataState<List<WeatherNews>>> fetchWeatherNews(String cityName) {
    // TODO: implement fetchWeatherNews
